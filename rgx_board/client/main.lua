...
Citizen.CreateThread(function()
	...
	Citizen.Wait(2000)
	ESX.TriggerServerCallback('prime_board:getConnectedPlayers', function(connectedPlayers)
...
RegisterNetEvent('prime_board:updateConnectedPlayers')
AddEventHandler('prime_board:updateConnectedPlayers', function(connectedPlayers)
	UpdatePlayerTable(connectedPlayers)
end)

RegisterNetEvent('prime_board:updatePing')
AddEventHandler('prime_board:updatePing', function(connectedPlayers)
	SendNUIMessage({
		action  = 'updatePing',
...
RegisterNetEvent('prime_board:toggleID')
AddEventHandler('prime_board:toggleID', function(state)
	if state then
		idVisable = state
	else
